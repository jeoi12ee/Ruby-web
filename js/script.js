...
commands: [
      {
        name: "/autoplay",
        description: "Automatically plays related songs when the current queue ends, keeping the music flowing seamlessly.",
        permission: "All",
     },
      {
        name: "/clear",
        description: "Clears all songs from the current music queue.",
        permission: "All",
     },
      {
        name: "/disconnect",
      ...
      {
        name: "/join",
        description: "Invites the bot to join your current voice channel.",
        permission: "All",
      },
     {
        name: "/loop",
        description: "Sets the loop Alle for the player: off, track, or queue. Repeat your favorite song or the entire playlist.",
        permission: "All",
      },
      {
        name: "/lyrics",
        description: "Displays the lyrics for the song currently playing, if available.",
        permission: "All",
     },
     {
        name: "/nowplaying",
        description: "Shows detailed information about the song currently playing, including its title, artist, and duration.",
        permission: "All",
     },
     {
        name: "/pause",
        description: "Pauses the music playback in the voice channel.",
        permission: "All",
     },
     {
        name: "/play",
        description: "Starts playing a song, playlist, or album from various sources like YouTube, Spotify, and more. Just provide a name or URL.",
        permission: "All",
      },
     {
        name: "/queue",
        description: "Displays the list of songs currently in the queue, allowing you to see what's coming up next.",
        permission: "All",
     },
     {
        name: "/remove",
        description: "Removes a specific song from the queue by its position number.",
        permission: "All",
     },
      { 
        name: "/replay",
      ...
      {
        name: "/resume",
        description: "Resumes playback if the music is currently paused.",
        permission: "All",
     },
      {
        name: "/search",
        description: "Searches for songs on YouTube and other platforms and allows you to select from the results to add to the queue.",
        permission: "All",
     },
      {
        name: "/seek",
        description: "Seeks to a specific timestamp in the current song (e.g., `/seek 1:30` to go to 1 minute 30 seconds).",
        permission: "All",
     },
      {
        name: "/shuffle",
        description: "Shuffles the order of songs in the current queue.",
        permission: "All",
     },
      {
        name: "/skip",
        description: "Skips the current song and plays the next track in the queue.",
        permission: "All",
      },
      {
        name: "/stop",
        description: "Stops the music playback entirely and clears the queue.",
        permission: "All",
      },
      {
        name: "/volume",
        description: "Adjusts the playback volume of the bot in your voice channel.",
        permission: "All",
      },
    ],
  },
category2: {
  ...
  commands: [
    {
      name: "/247",
      description: "Description of 247",
      permission: "All",
    },
    {
      name: "/djrole",
      description: "Description of djrole",
      permission: "Admin",
    },
    {
      name: "/ignorechannel",
      description: "Description of ignorechannel",
      permission: "Admin",
    },
    {
      name: "/prefix",
    ...
    {
      name: "/restrict",
      description: "Description of restrict",
      permission: "Admin",
    },
    {
      name: "/setup",
    ...
    {
      name: "/setupplayer",
      description: "Description of setupplayer",
      permission: "Admin",
    },
    {
      name: "/unrestrict",
      description: "Description of unrestrict",
      permission: "Admin",
    },
  ],
},
category3: {
  ...
  commands: [
    ...
    {
      name: "/bonk",
      description: "Description of bonk",
      permission: "All",
    },
    {
      name: "/cat",
    ...
    {
      name: "/cry",
      description: "Description of cry",
      permission: "All",
    },
    {
      name: "/cuddle",
      description: "Description of cuddle",
      permission: "All",
    },
    {
      name: "/adance",
      description: "Description of adance",
      permission: "All",
    },
    {
      name: "/hug",
      description: "Description of hug",
      permission: "All",
    },
    {
      name: "/kill",
      description: "Description of kill",
      permission: "All",
    },
    {
      name: "/pat",
      description: "Description of pat",
      permission: "All",
    },
    {
      name: "/poke",
      description: "Description of poke",
      permission: "All",
    },
    {
      name: "/punch",
    ...
    {
      name: "/roast",
      description: "Description of roast",
      permission: "All",
    },
    {
      name: "/slap",
      description: "Description of slap",
      permission: "All",
    },
    {
      name: "/wink",
      description: "Description of wink",
      permission: "All",
    },
  ],
},
category4: {
  ...
  commands: [
    ...
    {
      name: "/stats",
      description: "Description of stats",
      permission: "All",
    },
    {
      name: "/support",
    ...
    {
      name: "/uptime",
      description: "Description of uptime",
      permission: "All",
    },
    {
      name: "/vote",
    ...
    {
      name: "/premium",
      description: "Description of premium",
      permission: "All",
    },
    {
      name: "/premiumstatus",
      description: "Description of premiumstatus",
      permission: "All",
    },
    {
      name: "/npreq",
      description: "Description of npreq",
      permission: "All",
    },
  ],
  },
